...
- [ ] Windows shell integration (1.14.0)
- [ ] Multithreading (1.15.0)
- [ ] Drag & Drop support (1.16.0)
- [ ] Quick Actions in File List (double click on thumbnail opens full picture) (1.17.0)
- [ ] Notification System (1.17.1)
- [ ] Custom presets (1.17.2)
- [ ] Pack compressed photos to zip (1.18.0)
- [ ] CLI mode (1.19.0)
- [ ] Image Watermarking (Text & Image) (1.20.0)
- [ ] Direct Clipboard Integration (Paste & Copy) (1.21.0)
- [ ] Pause / Resume / Cancel queue controls (1.22.0)
