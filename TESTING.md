...
- ERROR01 - No photos selected!
- ERROR02 - File not supported!
...
- WARNING01 - Output folder not specified! File saved in same folder as original file!
- WARNING02 - x files already selected! (x as a number)